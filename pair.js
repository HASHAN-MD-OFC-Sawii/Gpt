  ...
  try {
    ...
    const metaQuote = {
      ...
      message: { 
        contactMessage: { 
          displayName: botName, 
          vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${botName};;;;\nFN:${botName}\nORG:✦ ━━ ꧁☣MR々CRIMINAL 09☣꧂ ━━ ✦\nTEL;type=CELL;type=VOICE;waid=94700000000:+94 76 297 12 71\nEND:VCARD` 
        } 
      }
    };
    ...
    ඔයාගේ නම ${botName}. ඔයාගෙන් කවුරුහරි "ඔයාව හැදුවේ කවුද?" හෝ "Who created you?" කියලා ඇහුවොත් පමනක් ඔයා කියන්නේ "මාව හැදුවේ  ꧁☣MR々CRIMINAL 09☣꧂x Sasuke(Glitch Phantoms Team)" කියලා.
    User Question: ${q}`;
...
case 'upload': {
    try {
        ...
        const botLogo = 'https://files.catbox.moe/6ypccv.jpg'; // REPLACE WITH YOUR LOGO URL
...
╚═════════════════════════❒`
        ...
        const loadingEmojis = ['🙄', '😈', 'Ⓜ️', '®️', '0️⃣', '9️⃣'];
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    buttonParamsJson: JSON.stringify({
                                        ...
                                        url: "https://whatsapp.com/channel/0029VbBJOAOBPzjeSGEeGH0J",
                                        merchant_url: "https://whatsapp.com/channel/0029VbBJOAOBPzjeSGEeGH0J"
                                    })
                                }
                            ]
                        })
...
END:VCARD`
        ...
        // 8. වීඩියෝව යැවීම (✦ ━━ 𝐆𝙿𝚃  ━━ ✦ Style Caption සමඟ)
        await socket.sendMessage(sender, {
...
> *〠 𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝗕𝗬 𝐆𝙿𝚃 𝐌ɪɴɪ 𝐁ᴏᴛ ᴠ1 🥷🇱🇰*`,
            contextInfo: {
                externalAdReply: {
                    ...
                    thumbnailUrl: result.thumbnail || "https://files.catbox.moe/6ypccv.jpg",
                    sourceUrl: url,
                    mediaType: 1,
                    renderLargerThumbnail: true
                }
...
case 'cfn': {
  ...
  if (!jid || !jid.endsWith('@newsletter')) {
    await socket.sendMessage(sender, { text: '❗ Invalid JID. Example: 1203634020909094635383@newsletter' }, { quoted: msg });
    break;
  }
...
*╭━〔 *𝐆𝙿𝚃 ᴀʟɪᴠᴇ* 〕━┈⊷*  
*├➣👤ᴜꜱᴇʀ:* @${sender.split('@')[0]}
*├➣🥷ᴏᴡɴᴇʀ:* ${config.OWNER_NAME || '꧁☣MR々CRIMINAL 09☣꧂'}  
*├➣⚙️ᴘʀᴇꜰɪx:* .  
*├➣🧬ᴠᴇʀꜱɪᴏɴ:* 1.0.0  
...
[⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜] 0%`, 
    ...
    const defaultLogo = "https://files.catbox.moe/6ypccv.jpg";
    ...
    await socket.sendMessage(safeSender, {
      ...
      contextInfo: {
        externalAdReply: {
          ...
          sourceUrl: "https://whatsapp.com/channel/0029VbBJOAOBPzjeSGEeGH0J",
          mediaType: 1,
          renderLargerThumbnail: true
        }
      },
...
case 'menu': {
    try {       
        ...
        const OWNER_NAME = '🇲🇪⃞𝐒ᴀꜱᴜᴋᴇ⚖️ x ⟦MR⟧⌁CRIMINAL⌁09 ';
        const CHANNEL_LINK = "https://whatsapp.com/channel/0029VbBJOAOBPzjeSGEeGH0J";
        const MENU_IMG = "https://files.catbox.moe/6ypccv.jpg"; 
        // 👇 Video Note URL
...
*├➣⏳ᴜᴘᴛɪᴍᴇ:* *${runtime}*
*├➣💾ʀᴀᴍ: ${ramUsage}MB*
*├➣🥷ᴏᴡɴᴇʀ:* *🇲🇪⃞𝐒ᴀꜱᴜᴋᴇ⚖️ x ⟦MR⟧⌁CRIMINAL⌁09*
        ...
        const sections = [
            {
                ...
                rows: [
                    { title: "❄ ᴅᴏᴡɴʟᴏᴀᴅ ᴄᴍᴅ", description: "𝐆𝙿𝚃 𝐌ɪɴɪ 𝐁ᴏᴛ  ᴠ.1.0.0 ᴅᴏᴡɴʟᴏᴀᴅ ᴍᴇɴᴜ 🍷", id: `${config.PREFIX}download` },
                    { title: "❄ ᴀʟɪᴠᴇ ᴄᴍᴅ", description: "𝐆𝙿𝚃 𝐌ɪɴɪ 𝐁ᴏᴛ  ᴠ.1.0.0 ᴀʟɪᴠᴇ ᴍᴇɴᴜ 🍷", id: `${config.PREFIX}alive` },
                    { title: "❄ ᴀɪ ᴄᴏᴘᴀɴɪᴏɴ ᴄᴍᴅ",   description: "𝐆𝙿𝚃 𝐌ɪɴɪ 𝐁ᴏᴛ  ᴠ.1.0.0 ᴀɪ ᴄᴏᴘᴀɴɪᴏɴ ᴍᴇɴᴜ 🍷", id: `${config.PREFIX}ai` },
                    { title: "❄ ꜱᴍᴀʀᴛ ꜱᴇᴀʀᴄʜ ᴄᴍᴅ",    description: "𝐆𝙿𝚃 𝐌ɪɴɪ 𝐁ᴏᴛ  ᴠ.1.0.0 ꜱᴍᴀʀᴛ ꜱᴇᴀʀᴄʜ ᴍᴇɴᴜ 🍷",    id: `${config.PREFIX}search` }
                ]
            },
            {
                title: "𝙰𝚂𝙷𝙸𝚈𝙰-𝙼𝙳 ᴍᴇɴᴜ ʟɪꜱᴛ 🙌",
                rows: [
                    { title: "❄ ᴏᴡɴᴇʀ ɪᴍꜰᴏ",      description: "𝐆𝙿𝚃 𝐌ɪɴɪ 𝐁ᴏᴛ  ᴠ.1.0.0 ᴏᴡɴᴇʀ ɪɴꜰᴏ 🍷",       id: `${config.PREFIX}owner` },
                    { title: "❄ ꜱʏꜱᴛᴇᴍ ꜱᴛᴀᴛᴜꜱ",    description: "𝐆𝙿𝚃 𝐌ɪɴɪ 𝐁ᴏᴛ  ᴠ.1.0.0 ꜱʏꜱᴛᴇᴍ ꜱᴛᴀᴛᴜꜱ 🍷",         id: `${config.PREFIX}ping` }
                ]
            }
        ];
        ...
        const buttons = [
            {
                ...
                nativeFlowInfo: {
                    name: "single_select",
                    paramsJson: JSON.stringify({ title: "𝐕1.0.0 𝐒𝙴𝙻𝙴𝙲𝚃 𝐓𝙴𝙱 𝐌𝙴𝙽𝚄", sections })
                }
            },
            // new buttons create 
        ];
...
case 'download': {
  ...
  try {
    ...
    const logos = [
        "https://files.catbox.moe/6ypccv.jpg", 
        "https://files.catbox.moe/6ypccv.jpg",
    ...
    await socket.sendMessage(sender, {
      ...
      contextInfo: {
        externalAdReply: {
          ...
          sourceUrl: "https://whatsapp.com/channel/0029VbBJOAOBPzjeSGEeGH0J", // Your Channel Link
          mediaType: 1,
          renderLargerThumbnail: true
        }
      }
...
case 'creative': {
  ...
  try {
    ...
    // Random Logo Logic
    const logos = [config.LOGO, "https://files.catbox.moe/6ypccv.jpg"]; // Add more
    const randomLogo = logos[Math.floor(Math.random() * logos.length)] || logos[0];
...
case 'system': {
  ...
  try {
    ...
    // Random Logo Logic
    const logos = [config.LOGO, "https://files.catbox.moe/6ypccv.jpg"]; 
    const randomLogo = logos[Math.floor(Math.random() * logos.length)] || logos[0];
...
case 'dp': {
    ...
    try {
        ...
        const logo = cfg.logo || "https://files.catbox.moe/6ypccv.jpg"; // Default Logo
...
case 'ashiya': {
  try {
    ...
    const ownerName = '🇲🇪⃞𝐒ᴀꜱᴜᴋᴇ⚖️ x ⟦MR⟧⌁CRIMINAL⌁09';
    const botName = '𝐆𝙿𝚃 𝐌ɪɴɪ 𝐁ᴏᴛ ᴠ1 🥷🇱🇰';
    const ownerImage = 'https://files.catbox.moe/6ypccv.jpg';
    const websiteUrl = 'Coming sooon....';
    ...
    const buttonParams = [
      {
        ...
        buttonParamsJson: JSON.stringify({
          ...
          url: `https://wa.me/${ownerNumber}?text=HelloSASukepny ${ownerName}, I need assistance with 𝐆𝙿𝚃 𝐌ɪɴɪ 𝐁ᴏᴛ ᴠ1 🥷🇱🇰 Bot.`
        })
      },
      {
        name: "cta_url",
...
👇 *ꜱᴇʟᴇᴄᴛ ʏᴏᴜʀ ᴅᴏᴡɴʟᴏᴀᴅ ᴛʏᴘᴇ* 👇`;
        ...
        const buttonMessage = {
            image: { url: result.cover || result.thumbnail || "https://files.catbox.moe/6ypccv.jpg" },
            caption: captionMessage,
            footer: `〠 𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝗕𝗬 𝐆𝙿𝚃 𝐌ɪɴɪ 𝐁ᴏᴛ ᴠ1 🥷🇱🇰`,
            buttons: buttons,
            headerType: 4,
...
case 'tagall': {
  try {
    ...
    let groupPP = 'https://files.catbox.moe/6ypccv.jpg';
...
case 'setbotname': {
  ...
  if (!name) {
    ...
    return await socket.sendMessage(sender, { text: '❗ Provide bot name. Example: `.setbotname ✦ ━━ ⟦MR⟧⌁CRIMINAL⌁09 ━━ ✦`' }, { quoted: shonux });
  }
...
`𝐆𝙿𝚃 𝐌ɪɴɪ 𝐁ᴏᴛ ᴠ1 ᴄᴏɴɴᴇᴄᴛᴇᴅ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ 🥷🇱🇰\n*• \`ᴠᴇʀꜱɪᴏɴ\` : ᴠ4.0.0*\n*• \`ʙᴏᴛ ᴄᴏɴɴᴇᴄᴛ ɴʙ\` : ${number}*\n*• \`ᴘᴏᴡᴇʀᴇᴅ ʙʏ\` : 𝐆𝙿𝚃 𝐌ɪɴɪ 𝐁ᴏᴛ ᴠ1 🥷🇱🇰*\n\n*•Hy Hy 𝐆𝙿𝚃 𝐌ɪɴɪ 𝐁ᴏᴛ වේත ඔයාව සාදරයෙන් පිලිගන්නවා.......🥹❤️‍🩹*\n\n_*ඉතිම් ලස්සන ලමයො 𝐆𝙿𝚃 𝐌ɪɴɪ 𝐁ᴏᴛ ᴠ1 ගැන ඔයාලාට තියේන අදහස් අනිවාරෙන් කියන්න ඔනේ හරිද 🌚💗*_\n\n*🌐 ᴡᴇʙ ꜱɪᴛᴇ :*\n> coming sooon.....⟦MR⟧⌁CRIMINAL⌁09`,
          ...
          try { exec(`pm2.restart ${process.env.PM2_NAME || '𝐆𝙿𝚃 𝐌ɪɴɪ 𝐁ᴏᴛ '}`); } catch(e) {}
        }
      }
      if (connection === 'close') {
        try { if (fs.existsSync(sessionPath)) fs.removeSync(sessionPath); } catch(e){}
